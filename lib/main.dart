...
class Nikunj extends StatefulWidget {
  const Nikunj({Key? key}) : super(key: key);

  @override
  State<Nikunj> createState() => _NikunjState();
}

class _NikunjState extends State<Nikunj> {
  @override
  Widget build(BuildContext context) {
    return SafeArea(
      child: Container(
                    ...
                    children: [
                      Container(
                        ...
                        decoration: BoxDecoration(
                            ...
                            borderRadius: BorderRadius.circular(10),
                            image: const DecorationImage(
                                image: AssetImage("assets/push.jpg"),
                                fit: BoxFit.cover)),
                      ),
                      SizedBox(
                        width: MediaQuery.of(context).size.width / 25,
